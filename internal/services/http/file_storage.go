...
// @Security     BearerAuth
// @Param        Authorization  header  string  true  "Bearer JWT token"  example("Bearer eyJhbGciOiJIUzI1NiIs...")
// @Param        request  body  DeleteRequest  true  "List of file paths to delete"  example({"paths":["public/avatar/user-avatar.jpg","private/catalog/123e4567-e89b-12d3-a456-426614174000.pdf"]})
